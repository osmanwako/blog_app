...
RSpec.describe User, type: :model do
  ...
  context("II) Testing Model methods\n") do
    ...
    let(:post1) { Post.new author: author, title: "Hi Rails", comments_counter: 0, likes_counter: 0 }
    let(:post2) { Post.new author: author, title: "Hi Laravel", comments_counter: 0, likes_counter: 0 }
    let(:post3) { Post.new author: author, title: "Hi Djiango", comments_counter: 0, likes_counter: 0 }
    let(:post4) { Post.new author: author, title: "Hi React", comments_counter: 0, likes_counter: 0 }
